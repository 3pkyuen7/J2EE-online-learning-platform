 ...
 * @author ljp85
 */
@WebServlet(name = "HandleQuizAdd", urlPatterns = {"/HandleQuizAdd"})
public class HandleQuizAdd extends HttpServlet{
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        db.createQuiz(name,qN, rT);
        //HandleQuizAdd?quizName=ss&qN=22&rT=22
            targetURL = "HandleShowQuizList";
