 ...
 * @author ljp85
 */
@WebServlet(name = "HandleRemoveQuestion", urlPatterns = {"/HandleRemoveQuestion"})
public class HandleRemoveQuestion extends HttpServlet{
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(db.removeQuizQuestion(qID,quesId))
            targetURL = "HandleAddQuiz?quizID="+qID;
